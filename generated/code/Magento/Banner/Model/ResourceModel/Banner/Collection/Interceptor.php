...
class Interceptor extends \Magento\Banner\Model\ResourceModel\Banner\Collection implements \Magento\Framework\Interception\InterceptorInterface
{
    ...
    public function addStoresVisibility()
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addStoresVisibility', func_get_args(), $pluginInfo) : parent::addStoresVisibility();
    }
    ...
    public function addStoreFilter($storeIds, $withAdmin = true)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addStoreFilter', func_get_args(), $pluginInfo) : parent::addStoreFilter($storeIds, $withAdmin);
    }
    ...
    public function addBannerIdsFilter($bannerIds, $exclude = false)
    {
        ...
        return $pluginInfo ? $this->___callPlugins('addBannerIdsFilter', func_get_args(), $pluginInfo) : parent::addBannerIdsFilter($bannerIds, $exclude);
    }
