...
/**
 * Recipient Email resolver for Giftcard Cart Item
 */
class RecipientEmail implements ResolverInterface
{
    /**
     * @inheritdoc
     */
    public function resolve(
        ...
        return $cartItem->getOptionByCode(Option::KEY_RECIPIENT_EMAIL)
            ->getValue();
    }
}
