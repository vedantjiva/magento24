...
class WishlistDataCleanUp implements DataPatchInterface
{
    ...
    {
        try {
            $this->cleanMagentoGiftregistryItemOptionTable();
        } catch (\Throwable $e) {
            $this->logger->warning(
                'Giftregistry module WishlistDataCleanUp patch experienced an error and could not be completed.'
    ...
    /**
     * Remove login data from magento_giftregistry_item_option table.
     *
     * @throws LocalizedException
     */
    private function cleanMagentoGiftregistryItemOptionTable()
    {
